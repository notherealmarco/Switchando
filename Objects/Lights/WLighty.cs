...
namespace HomeAutomation.Objects.Lights
{
    class WLighty : ILight
    {
        ...
        public WLighty(Client client, string Name, uint pin, string description, string[] FriendlyNames)
        {
            this.Client = client;
        ...
        private static WLighty FindLightFromName(string name)
        {
            WLighty light = null;
        ...
        public static string SendParameters(string method, string[] request, Identity login)
        {
            ...
            if (method.Equals("create"))
            {
                ...
                WLighty light = new WLighty(client, name, pin, description, friendlyNames);
                room.AddItem(light);
